...
import { canOpenPart } from '/shared/progression.js';
import { resolvePartToPlay } from '/shared/partLoader.js';
import { repairTrainingQueueProgress } from '/shared/trainingQueue.js';
import { ensureIndicesConsultes } from '/shared/hintConsult.js';
...
const PART_LOADERS = {
  prologue: {
    url: '/content/prologue/scenes.json',
    labelPrefix: 'Prologue',
  },
  part1: {
    url: '/content/part1/scenes.json',
    labelPrefix: 'Partie 1',
  },
  part2: {
    url: '/content/part2/scenes.json',
    labelPrefix: 'Partie 2',
  },
  part3: {
    url: '/content/part3/scenes.json',
    labelPrefix: 'Partie 3',
  },
  part4: {
    url: '/content/part4/scenes.json',
    labelPrefix: 'Partie 4',
  },
  part5: {
    url: '/content/part5/scenes.json',
    labelPrefix: 'Partie 5',
  },
  part6: {
    url: '/content/part6/scenes.json',
    labelPrefix: 'Partie 6',
  },
  part7: {
    url: '/content/part7/scenes.json',
...
function showWaitingNextPart(
  ...
  const bg =
    options.background ||
    '/assets/backgrounds/part4/p4-arrivee-ile-paralleles.png';
...
function waitingOptionsForPart(partId) {
  ...
  return {
    ...
    partLabel: 'Bientôt',
    background: '/assets/backgrounds/part7/p7-6-conclusion-tresor.png',
  };
}
...
function showGameCompleted(shell, playerName, refreshStatus, shared) {
  const bg = '/assets/backgrounds/part7/p7-6-conclusion-tresor.png';
  shell.stage.innerHTML = `
    <div class="scene-frame">
      <div class="scene-decor">
        <div class="scene-bg" style="background-image:url('${bg}')"></div>
      ...
      if (endedId === 'part1' && goToNextPart) {
        ...
        if (PART_LOADERS.part2) {
          ...
          showWaitingNextPart(shell, playerName, refreshStatus, shared, {
            ...
            background: '/assets/backgrounds/part1/recif-angles-droits.png',
          });
        }
        return;
      }
      ...
      if (endedId === 'part3' && goToNextPart) {
        ...
        if (PART_LOADERS.part4) {
          ...
          showWaitingNextPart(shell, playerName, refreshStatus, shared, {
            ...
            background: '/assets/backgrounds/part3/p3-arrivee-moulin.png',
          });
        }
        return;
      }
