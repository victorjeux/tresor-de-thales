 ...
 */
import { checkNumericAnswer } from '/shared/numericAnswer.js';
...
const SPEAKER_PORTRAITS = {
  alizée: '/assets/portraits/alizee.png',
  alizee: '/assets/portraits/alizee.png',
  nérée: '/assets/portraits/neree.png',
  neree: '/assets/portraits/neree.png',
  'capitaine nérée': '/assets/portraits/neree.png',
  euclide: '/assets/portraits/euclide.png',
  'maître euclide': '/assets/portraits/euclide.png',
  silas: '/assets/portraits/silas.png',
  maki: '/assets/portraits/maki.png',
  marin: null,
};
...
export class SceneEngine {
  ...
  renderDecor() {
    ...
    const fallback =
      ...
      '/assets/backgrounds/part1/recif-angles-droits.png';
  ...
  async playFragmentZoom(cfg) {
    return new Promise((resolve) => {
      ...
      const img =
        cfg.image || '/assets/objects/part1/fragment-carte-1.png';
      layer.innerHTML = `
  ...
  fragmentBoardImageSrc(i) {
    const n = Number(i) || 1;
    if (n === 1) return '/assets/objects/part1/fragment-carte-1.png';
    if (n === 2) return '/assets/objects/part2/fragment-carte-2.png';
    if (n === 3) return '/assets/objects/part3/fragment-carte-3.png';
    if (n === 4) return '/assets/objects/part4/fragment-carte-4.png';
    if (n === 5) return '/assets/objects/part5/fragment-carte-5.png';
    if (n === 6) return '/assets/objects/part6/fragment-carte-6.png';
    // Placeholders pour les fragments suivants
    return '/assets/objects/part1/fragment-carte-1.png';
  }
  ...
  playQuiz(step, { optional = false } = {}) {
    ...
    const makiPortrait = '/assets/portraits/maki.png';
    const euclidePortrait = '/assets/portraits/euclide.png';
    let solved = false;
